export default class StringService {
  ...
  public static toHslColor(value: string, s = 30, l = 80): string {
    let hash = 0;
  ...
  public static toKebabCase(value?: string, validCharsets = false): string | null {
  ...
  public static toCamelCase(value?: string, validCharsets = false): string | null {
    const text = validCharsets ? this.replaceInvalidCharsets(value) : value;
